    ...
    (t = jQuery),
      ...
      (e = {
            ...
            c.click(function () {
              ...
              }
              {
                ...
                (i.sbId = n),
                  ...
                  i.sbPrice.toFixed(2),
                  a.productQuantityWrapper
                    ? ((i.sbPriceCommon = +t(this).attr(
                        'data-sb-product-price'
                      )),
                    ...
                    : ((i.sbPriceCommon = +t(this).attr(
                      ...
                      i.sbPriceCommon.toFixed(2)),
                  console.log(+t(this).data('sbProductQuantity'));
        ...
        commonResult: function (e, s, r) {
          let n = 0,
            ...
            l = t('<div>')
              ...
              .text('Замовлення прийнято. Очікуйте дзвінка')
              .css('display', 'none'),
          ...
          if ((0 == +n ? o.fadeIn() : o.fadeOut(), r))
            ...
            if (!s)
              return (
                ...
                p.html(
                  `<span>Загальна вартість: </span> <input name="finalPrice" aria-label="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(
                    2
            ...
            0 == +n && t('.' + o.attr('class')).css('display', 'block'),
              t('.' + d.attr('class')).html('<span>Всього товарів: </span> '),
              t('.' + d.attr('class')).html(
                `<span>Всього товарів: </span> ${n}`
              ),
              t('.' + p.attr('class')).html(
        ...
        getSmartBasketMinState: function (s, r) {
          ...
          r
            ...
            : (l.html(n), t('.' + a.smartBasketMinArea).append(i.append(l))),
          ...
          if ((c.append(p), a.agreement.isRequired)) {
            ...
            let e = t('<label>').attr({
              ...
              s = t('<input>').attr({
                ...
                value: 'Я приймаю умови користувача',
              }),
              r = null;
            (r = a.agreement.isLink
              ...
              s.is(':checked')
                ? r.text('Я приймаю умови користувача')
                : r.text('Я не приймаю умови користувача'),
              e.click(function () {
                s.is(':checked')
                  ? (r.text('Я не приймаю умови користувача'),
                    s.val('Я не приймаю умови користувача'),
                    m.attr({ disabled: 'disabled' }),
                    d.addClass('smart-basket__input-wrapper_error'))
                  : (r.text('Я приймаю умови користувача'),
                    s.val('Я приймаю умови користувача'),
                    m.attr({ disabled: !1 }),
        ...
        alertBlock: function (a) {
          ...
          return (
            ...
            'alreadyAdded' === a &&
              ...
              i.append('Товар вже доданий до кошика')),
            o.append(l).append(c),
      ...
      (t.fn.smbasket = function (a) {
        return e[a]
          ...
          : 'object' != typeof a && a
          ? void t.error('Метод ' + a + ' не знайдений')
